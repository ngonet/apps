    ...
    <>
      <div className="login login-v2 fw-bold">
        <div className="login-cover">
          <div className="login-cover-img" style={{ backgroundImage: `url(${activeBg})` }} />
      ...
      <div className="login-bg-list clearfix">
        <div className={`login-bg-list-item ${bg1 ? 'active' : ''}`}>
          <Link
            to="/user/login-v2"
            onClick={(e) => selectBg(e, 'bg1', '/assets/img/login-bg/login-bg-17.jpg')}
        ...
        <div className={`login-bg-list-item ${bg2 ? 'active' : ''}`}>
          <Link
            to="/user/login-v2"
            onClick={(e) => selectBg(e, 'bg2', '/assets/img/login-bg/login-bg-16.jpg')}
            style={{ backgroundImage: 'url(/assets/img/login-bg/login-bg-16.jpg)' }}
            className="login-bg-list-link"
          />
        </div>
        <div className={`login-bg-list-item ${bg3 ? 'active' : ''}`}>
          <Link
            to="/user/login-v2"
            onClick={(e) => selectBg(e, 'bg3', '/assets/img/login-bg/login-bg-15.jpg')}
            style={{ backgroundImage: 'url(/assets/img/login-bg/login-bg-15.jpg)' }}
            className="login-bg-list-link"
          />
        </div>
        <div className={`login-bg-list-item ${bg4 ? 'active' : ''}`}>
          <Link
            to="/user/login-v2"
            onClick={(e) => selectBg(e, 'bg4', '/assets/img/login-bg/login-bg-14.jpg')}
        ...
        <div className={`login-bg-list-item ${bg5 ? 'active' : ''}`}>
          <Link
            to="/user/login-v2"
            onClick={(e) => selectBg(e, 'bg5', '/assets/img/login-bg/login-bg-13.jpg')}
            style={{ backgroundImage: 'url(/assets/img/login-bg/login-bg-13.jpg)' }}
            className="login-bg-list-link"
          />
        </div>
        <div className={`login-bg-list-item ${bg6 ? 'active' : ''}`}>
          <Link
            to="/user/login-v2"
            onClick={(e) => selectBg(e, 'bg6', '/assets/img/login-bg/login-bg-12.jpg')}
            style={{ backgroundImage: 'url(/assets/img/login-bg/login-bg-12.jpg)' }}
            className="login-bg-list-link"
          />
        </div>
      </div>
