...
const authRoutes = [{
  ...
  path: '/auth-3/reset-password',
  element: <Auth3ResetPassword />
}, {
  path: '/auth-3/new-password',
  element: <Auth3NewPassword />
}, {
  path: '/auth-3/two-factor',
  element: <Auth3TwoFactor />
}, {
  path: '/auth-3/lock-screen',
  element: <Auth3LockScreen />
}, {
  path: '/auth-3/success-mail',
  element: <Auth3SuccessMail />
}, {
  path: '/auth-3/login-pin',
  element: <Auth3LoginPin />
}, {
  path: '/auth-3/delete-account',
  element: <Auth3DeleteAccount />
}];
const errorRoutes = [{
  path: '/error/400',
  element: <Error400 />
...
const layoutRoutes = [{
  ...
  element: <TopbarWithSubItems />
}, {
  path: '/layouts/topbars/with-tools',
  element: <TopbarWithTools />
}];
const allRoutes = [{
  element: <MainLayout />,
  children: [{
