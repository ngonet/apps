  ...
  return <div className="topbar-item">
      <Dropdown align="end">
        ...
        <DropdownMenu className="p-0 dropdown-menu-end dropdown-menu-lg">
          ...
          <Link to="javascript:void(0);" className="dropdown-item text-center text-reset text-decoration-underline link-offset-2 fw-bold notify-item border-top border-light py-2">
            View All Alerts
          </Link>
        </DropdownMenu>
      </Dropdown>
