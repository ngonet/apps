  ...
  return <Offcanvas show={customizer.isOpen} onHide={customizer.toggle} placement="end" className="overflow-hidden">
      ...
      <div className="offcanvas-footer border-top p-3 text-center">
        <Row>
          ...
          <Col sm={6}>
            <Link to="https://wrapbootstrap.com/theme/inspinia-multipurpose-admin-dashboard-template-WB0R5L90S?ref=inspinia" target="_blank" className="btn btn-danger bg-gradient py-2 fw-semibold w-100">
              Buy Now
            </Link>
          </Col>
        </Row>
