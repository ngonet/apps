            ...
            <CardBody className="min-vh-100 d-flex flex-column justify-content-center">
              ...
              <div className="mt-auto text-center">
                ...
                <Form className="mt-4">
                  <div className="mb-3">
                    <InputGroup>
                      <FormControl type="email" className="py-2 px-3 bg-light bg-opacity-40 border-light" id="userEmail" placeholder="Enter username or email" required />
                    </InputGroup>
                  </div>

                  <div className="mb-3">
                    <InputGroup>
                      <FormControl type="password" className="py-2 px-3 bg-light bg-opacity-40 border-light" id="userPassword" placeholder="Enter password" required />
                    </InputGroup>
                  </div>
