            ...
            <CardBody className="min-vh-100 d-flex flex-column justify-content-center">
              ...
              <div className="mt-auto text-center">
                ...
                <Form>
                  ...
                  <div className="mb-3">
                    <OTPInput code={code} setCode={setCode} label="Enter your 6-digit code" labelClassName="d-flex" inputClassName="py-2 bg-light bg-opacity-40 border-light" />
                  </div>

                  <div className="mb-3" data-password="bar">
                    <PasswordInputWithStrength id="userPassword" name="user-password" password={password} setPassword={setPassword} placeholder="Enter Password" inputClassName="py-2 px-3 bg-light bg-opacity-40 border-light" />
                  </div>

                  <div className="mb-3">
                    <InputGroup>
                      <FormControl type="password" className="py-2 px-3 bg-light bg-opacity-40 border-light" id="confirmPassword" placeholder="Confirm New password" required />
                    </InputGroup>
                  </div>
