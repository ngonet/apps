            ...
            <CardBody className="min-vh-100 d-flex flex-column justify-content-center">
              ...
              <div className="mt-auto text-center">
                ...
                <Form className="mt-4">
                  <div className="mb-3">
                    <InputGroup>
                      <input type="text" className="form-control py-2 px-3 bg-light bg-opacity-40 border-light" id="userName" placeholder="Enter name" required />
                    </InputGroup>
                  </div>

                  <div className="mb-3">
                    <InputGroup>
                      <input type="email" className="form-control py-2 px-3 bg-light bg-opacity-40 border-light" id="userEmail" placeholder="Enter email" required />
                    </InputGroup>
                  </div>
