...
const PricingPlans = () => {
  const pricingPlans = [{
    ...
    features: [{
      text: '1 project usage',
      included: true
    }, {
      text: 'Full component access',
      included: true
    }, {
      text: 'Basic documentation',
      included: true
    }, {
      text: 'No multi-client use',
      included: false
    }, {
      text: 'No SaaS/resale rights',
      included: false
    }],
    ...
    features: [{
      text: 'Use in up to 5 projects',
      included: true
    }, {
      text: 'Commercial client use',
      included: true
    }, {
    ...
    features: [{
      text: 'Unlimited project usage',
      included: true
    }, {
      text: 'SaaS & resale rights',
      included: true
    }, {
      text: 'Full Figma source files',
      included: true
    }, {
      text: 'Priority support',
      included: true
    }, {
      text: 'Custom licensing agreement',
      included: true
    }],
    btnClass: 'btn-dark'
  }];
  return <section className="section-custom" id="plans">
      <Container>
        ...
        <Row className="justify-content-center">
          <Col xxl={10}>
            <Row>
              {pricingPlans.map((plan, idx) => <Col lg={4} key={idx} className={`${plan.isPopular && 'my-4 my-lg-0'}`}>
