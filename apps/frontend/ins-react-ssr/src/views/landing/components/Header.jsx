  ...
  return <>
      <Alert variant="primary" className="top-alert text-center mb-0 rounded-0" dismissible closeVariant="white">
        <div className="fst-italic fw-medium">
          ...
          <Link to="https://wrapbootstrap.com/theme/inspinia-multipurpose-admin-dashboard-template-WB0R5L90S?ref=inspinia" target="_blank" rel="noopener noreferrer" className="fw-semibold fst-normal text-white text-decoration-underline link-offset-3 ms-2">
            Buy Now!
          </Link>
        </div>
      </Alert>
