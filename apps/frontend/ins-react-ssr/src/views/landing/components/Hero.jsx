        ...
        <Row>
          <Col lg={8} className="mx-auto text-center">
            ...
            <div className="avatar-group avatar-group-sm justify-content-center mt-2 d-flex gap-1">
              {users.map((user, idx) => <div className="avatar" key={idx}>
            ...
            <div className="d-flex gap-2 flex-wrap justify-content-center">
              ...
              <a className="btn btn-light py-2 fw-semibold d-flex align-items-center" href="https://wrapbootstrap.com/user/WebAppLayers/message" target="_blank" rel="noopener noreferrer">
