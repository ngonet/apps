...
const Features = () => {
  ...
  const stats2 = [{
    value: 99.5,
    suffix: '%',
    label: 'File recovery success rate'
  }, {
    value: 3.2,
    suffix: 'x',
    label: 'Faster upload speed'
  }, {
    value: 1500,
    suffix: '+',
    label: 'Files organized per minute'
  }];
  const stats3 = [{
    value: 97.5,
    suffix: '%',
    ...
    value: 4.2,
    suffix: 'x',
    label: 'Faster contact search'
  }, {
    value: 250000,
    suffix: '+',
    label: 'Contacts managed daily'
  }];
      ...
      <div className="container">
        ...
        <div className="row align-items-center py-5">
          ...
          <div className="col-lg-5 ms-auto py-3">
            ...
            <div className="d-flex flex-wrap justify-content-between gap-4 mt-4">
              {stats3.map((state, idx) => <div key={idx}>
                  <h3 className="mb-2">
                    <CountUp end={state.value} decimals={1} duration={2} enableScrollSpy scrollSpyOnce />
                    <span className="text-primary">{state.suffix}</span>
                  </h3>
