...
const DashboardV3 = () => {
  ...
  function handleDateApplyEvent(event, picker) {
    ...
    const prevWeek = `${moment(startDate).subtract(gap, 'days').format('D MMMM')} - ${moment(
      startDate
    )
      .subtract(1, 'days')
      .format('D MMMM YYYY')}`;
  ...
  var dateRange = {
    ...
    prevWeek: `${moment().subtract(15, 'days').format('D MMMM')} - ${moment()
      .subtract(8, 'days')
      .format('D MMMM YYYY')}`,
  };
  ...
  const storeSessionChartOptions = {
    chart: {
      type: 'line',
      width: 160,
      height: 28,
      ...
      <div className="d-sm-flex align-items-center mb-3">
        <DateRangePicker startDate={startDate} endDate={endDate} onApply={handleDateApplyEvent}>
          <button className="btn btn-inverse me-2 text-truncate">
            <i className="fa fa-calendar fa-fw text-white text-opacity-50 ms-n1 me-1" />
            <span>{dateRange.currentWeek}</span>
            <b className="caret ms-1 opacity-5" />
          </button>
        </DateRangePicker>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-xl-7 col-lg-8">
                  ...
                  <div className="mb-3 text-gray-500">
                    <i className="fa fa-caret-up" /> 33.21% compare to last week
                  </div>
              ...
              <div className="card border-0 text-truncate mb-3 bg-gray-800 text-white">
                <div className="card-body">
                  ...
                  <div className="mb-4 text-gray-500 ">
                    <i className="fa fa-caret-down" /> 0.50% compare to last week
                  </div>
                  <div className="d-flex mb-2">
                    ...
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up" /> 262%
                      </div>
                  ...
                  <div className="d-flex mb-2">
                    <div className="d-flex align-items-center">
                      <i className="fa fa-circle text-warning fs-8px me-2" />
                      Reached checkout
                    </div>
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up" /> 11%
                      </div>
                  ...
                  <div className="d-flex">
                    <div className="d-flex align-items-center">
                      <i className="fa fa-circle text-lime fs-8px me-2" />
                      Sessions converted
                    </div>
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up" /> 57%
                      </div>
            ...
            <div className="col-sm-6">
              <div className="card border-0 text-truncate mb-3 bg-gray-800 text-white">
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center mb-1">
                    ...
                    <div className="ms-auto">
                      <Chart
                        type="line"
                        height="28px"
                        options={storeSessionChartOptions}
                        series={storeSessionChartSeries}
                      />
                    </div>
                  </div>
                  <div className="mb-4 text-gray-500 ">
                    <i className="fa fa-caret-up" /> 9.5% compare to last week
                  </div>
                  <div className="d-flex mb-2">
                    <div className="d-flex align-items-center">
                      <i className="fa fa-circle text-teal fs-8px me-2" />
                      Mobile
                    </div>
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up" /> 25.7%
                      </div>
                  ...
                  <div className="d-flex mb-2">
                    <div className="d-flex align-items-center">
                      <i className="fa fa-circle text-blue fs-8px me-2" />
                      Desktop
                    </div>
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up" /> 16.0%
                      </div>
                  ...
                  <div className="d-flex">
                    <div className="d-flex align-items-center">
                      <i className="fa fa-circle text-aqua fs-8px me-2" />
                      Tablet
                    </div>
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up" /> 7.9%
                      </div>
              ...
              <div className="row">
                <div className="col-xl-3 col-4">
                  ...
                  <div className="text-gray-500 small text-truncate">
                    <i className="fa fa-caret-up" /> 25.5% from previous 7 days
                  </div>
                </div>
                <div className="col-xl-3 col-4">
                  ...
                  <div className="text-gray-500 small text-truncate">
                    <i className="fa fa-caret-up" /> 5.33% from previous 7 days
                  </div>
                </div>
                <div className="col-xl-3 col-4">
                  ...
                  <div className="text-gray-500 small text-truncate">
                    <i className="fa fa-caret-up" /> 0.323% from previous 7 days
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              ...
              <div>
                ...
                <div className="d-flex align-items-center text-white mb-2">
                  <div
                    className="widget-img widget-img-xs rounded bg-inverse me-2 w-40px"
                    style={{ backgroundImage: 'url(/assets/img/flag/cn.jpg)' }}
                  />
                  <div className="d-flex w-100">
                    <div>China</div>
                ...
                <div className="d-flex align-items-center text-white mb-2">
                  <div
                    className="widget-img widget-img-xs rounded bg-inverse me-2 w-40px"
                    style={{ backgroundImage: 'url(/assets/img/flag/de.jpg)' }}
                  />
                  <div className="d-flex w-100">
                    <div>Germany</div>
                ...
                <div className="d-flex align-items-center text-white mb-2">
                  <div
                    className="widget-img widget-img-xs rounded bg-inverse me-2 w-40px"
                    style={{ backgroundImage: 'url(/assets/img/flag/fr.jpg)' }}
                  />
                  <div className="d-flex w-100">
                    <div>France</div>
                ...
                <div className="d-flex align-items-center text-white mb-0">
                  <div
                    className="widget-img widget-img-xs rounded bg-inverse me-2 w-40px"
                    style={{ backgroundImage: 'url(/assets/img/flag/jp.jpg)' }}
                  />
                  <div className="d-flex w-100">
                    <div>Japan</div>
          ...
          <div className="card border-0 mb-3 bg-gray-900 text-white">
            ...
            >
              ...
              <div className="text-gray-500 mb-1px">
                <i className="fa fa-caret-up" /> 45.76% increased
              </div>
            </div>
            <div className="widget-list rounded-bottom" data-bs-theme="dark">
              <Link to="/dashboard/v3" className="widget-list-item rounded-0 pt-3px">
                <div className="widget-list-media icon">
                  <i className="fab fa-apple bg-indigo text-white" />
                </div>
                <div className="widget-list-content">
                  <div className="widget-list-title">Apple Store</div>
                </div>
                <div className="widget-list-action text-nowrap text-gray-500">$34,840.17</div>
              </Link>
              <Link to="/dashboard/v3" className="widget-list-item">
                <div className="widget-list-media icon">
                  <i className="fab fa-facebook-f bg-blue text-white" />
                </div>
                <div className="widget-list-content">
                  <div className="widget-list-title">Facebook</div>
                </div>
                <div className="widget-list-action text-nowrap text-gray-500">$12,502.67</div>
              </Link>
              <Link to="/dashboard/v3" className="widget-list-item">
                <div className="widget-list-media icon">
                  <i className="fab fa-twitter bg-info text-white" />
                </div>
                <div className="widget-list-content">
                  <div className="widget-list-title">Twitter</div>
                </div>
                <div className="widget-list-action text-nowrap text-gray-500">$4,799.20</div>
              </Link>
              <Link to="/dashboard/v3" className="widget-list-item">
                <div className="widget-list-media icon">
                  <i className="fab fa-google bg-red text-white" />
                </div>
                <div className="widget-list-content">
                  <div className="widget-list-title">Google Adwords</div>
                </div>
                <div className="widget-list-action text-nowrap text-gray-500">$3,405.85</div>
              </Link>
              <Link to="/dashboard/v3" className="widget-list-item pb-3px rounded-bottom">
                <div className="widget-list-media icon">
                  <i className="fab fa-instagram bg-pink text-white" />
                </div>
                <div className="widget-list-content">
                  <div className="widget-list-title">Instagram</div>
                </div>
                <div className="widget-list-action text-nowrap text-gray-500">$0.00</div>
              </Link>
            </div>
          </div>
        </div>
              ...
              <div className="d-flex align-items-center mb-15px">
                <div className="widget-img rounded-3 me-10px bg-white p-3px w-30px">
                  <div
                    ...
                    style={{
                      background: 'url(/assets/img/product/product-8.jpg) center no-repeat',
              ...
              <div className="d-flex align-items-center mb-15px">
                <div className="widget-img rounded-3 me-10px bg-white p-3px w-30px">
                  <div
                    className="h-100 w-100"
                    style={{
                      background: 'url(/assets/img/product/product-9.jpg) center no-repeat',
                      backgroundSize: 'auto 100%',
                    }}
                  />
                </div>
              ...
              <div className="d-flex align-items-center mb-15px">
                <div className="widget-img rounded-3 me-10px bg-white p-3px w-30px">
                  <div
                    className="h-100 w-100"
                    style={{
                      background: 'url(/assets/img/product/product-10.jpg) center no-repeat',
                      backgroundSize: 'auto 100%',
                    }}
                  />
                </div>
              ...
              <div className="d-flex align-items-center mb-15px">
                <div className="widget-img rounded-3 me-10px bg-white p-3px w-30px">
                  <div
                    className="h-100 w-100"
                    style={{
                      background: 'url(/assets/img/product/product-11.jpg) center no-repeat',
                      backgroundSize: 'auto 100%',
                    }}
                  />
                </div>
              ...
              <div className="d-flex align-items-center">
                <div className="widget-img rounded-3 me-10px bg-white p-3px w-30px">
                  <div
                    className="h-100 w-100"
                    style={{
                      background: 'url(/assets/img/product/product-12.jpg) center no-repeat',
                      backgroundSize: 'auto 100%',
                    }}
                  />
                </div>
            ...
            <div className="card-body">
              ...
              <div className="row align-items-center pb-1px">
                ...
                <div className="col-8">
                  ...
                  <Link to="/dashboard/v3" className="btn btn-xs btn-indigo fs-10px ps-2 pe-2">
                    View campaign
                  </Link>
                </div>
              </div>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-8">
                  ...
                  <Link to="/dashboard/v3" className="btn btn-xs btn-warning fs-10px ps-2 pe-2">
                    View campaign
                  </Link>
                </div>
              </div>
