...
const DashboardV2 = () => {
  ...
  const pieChartSeries = [416747, 784466];
  ...
  function renderMap() {
    ...
    const gray700 = getComputedStyle(document.body).getPropertyValue('--bs-gray-700').trim();
    ...
    const bodyFontFamily = getComputedStyle(document.body)
      ...
      .trim();
    const map = document.querySelector('#jvectorMap');
    ...
    <>
      ...
      <div className="row">
          ...
          <div className="widget-chart with-sidebar inverse-mode">
            ...
            <div className="widget-chart-sidebar bg-gray-900">
              ...
              <ul className="chart-legend fs-11px">
                <li>
                  <i className="fa fa-circle fa-fw text-blue fs-9px me-5px t-minus-1" /> 34.0%{' '}
                  <span>New Visitors</span>
                </li>
                <li>
                  <i className="fa fa-circle fa-fw text-teal fs-9px me-5px t-minus-1" /> 56.0%{' '}
        ...
        <div className="col-xl-4">
          <Panel>
            <PanelHeader noButton>Visitors Origin</PanelHeader>
            <div style={{ height: '170px' }}>
              <div id="jvectorMap" style={{ height: '170px' }} />
            </div>
            <div className="list-group" data-bs-theme="dark">
              <div className="list-group list-group-flush " data-bs-theme="dark">
                ...
                <a
                  href="#/"
                  className="list-group-item list-group-item-action d-flex rounded-bottom"
                >
      ...
      <div className="row">
          ...
          <Panel className="bg-light">
            ...
            >
              <div className="chats-item start">
                ...
                <Link to="/dashboard/v2" className="name">
                  Sowse Bawdy
                </Link>
              ...
              <div className="chats-item end">
                ...
                <Link to="/dashboard/v2" className="name">
                  <span className="badge bg-blue">ADMIN</span> Me
                </Link>
                <Link to="/dashboard/v2" className="image">
        ...
        <div className="col-xl-4 col-lg-6">
          <Panel>
            <PanelHeader noButton>Today's Schedule</PanelHeader>
            <div>
              <Calendar value={date} />
            </div>
            ...
            <div className="list-group list-group-flush">
              <Link
                to="/dashboard/v2"
                className="list-group-item list-group-item-action d-flex justify-content-between align-items-center text-ellipsis"
              >
                Sales Reporting
              ...
              <Link
                to="/dashboard/v2"
                className="list-group-item list-group-item-action d-flex justify-content-between align-items-center text-ellipsis rounded-bottom"
              >
        ...
        <div className="col-xl-4 col-lg-6">
          <Panel>
            ...
            <PanelFooter className="text-center">
              <Link to="/dashboard/v2" className="text-decoration-none text-body">
                View All
              </Link>
            </PanelFooter>
          </Panel>
