    ...
    <div className="register register-with-news-feed">
      <div className="news-feed">
        <div
          ...
          style={{ backgroundImage: 'url(/assets/img/login-bg/login-bg-9.jpg)' }}
        />
          ...
          <form onSubmit={handleSubmit} className="fs-13px">
            ...
            <div className="form-check mb-4">
              ...
              <label className="form-check-label" htmlFor="agreementCheckbox">
                By clicking Sign Up, you agree to our <Link to="/user/register-v3">Terms</Link> and
                that you have read our <Link to="/user/register-v3">Data Policy</Link>, including
                our <Link to="/user/register-v3">Cookie Use</Link>.
              </label>
            </div>
            <div className="mb-4">
              <button type="submit" className="btn btn-theme d-block w-100 btn-lg h-45px fs-13px">
                Sign Up
              </button>
            </div>
            ...
            <p className="text-center text-gray-600">&copy; Color Admin All Right Reserved 2025</p>
          </form>
        </div>
      </div>
    </div>
